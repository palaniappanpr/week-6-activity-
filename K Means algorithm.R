...
# this model created cluster for each classification and performed the algorithm. Results are showed in table format 
#TASK: Accuracy = number of correctly classified/(total classified) = 133/150 = 0.886
#i.e our model has achieved ?% accuracy! = 88.6%
