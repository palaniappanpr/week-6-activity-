...
#This model classified data into 3 factors and determine the predicted and actual value for each factors. 
# Plotted the classification plot with color and shows how its spread
#What is the accuracy rate?
# accuracy rate is about 97%
